...
class ValidatePerformance:
    def __init__(self, data_name, model_config, train_config, test_config):
        ...
        self.result_path_prefix = '/home/jiangyiheng/MiRec/results/'
        self.model_path_prefix = '/home/jiangyiheng/MiRec/models/'
...
if __name__ == '__main__':
    model_config = {'model_name': None,
                    'embed_dim': 64,
                    'num_latent': 10,}
    train_config = {'batch_size': {'ml1m': 64, 'yelp': 32, 'book': 56, 'beauty': 64, 'sports': 128, 'ml100k': 64,
                                   'tky': 64, 'nyc': 64},
                    'max_len': {'ml1m': 160, 'yelp': 50, 'book': 50, 'beauty': 30, 'sports': 30, 'ml100k': 100,
                                'tky': 50, 'nyc': 30},
                    'device': 'cuda:0',
                    'learning_rate': 0.001,
                    'test_interval': 1,
                    ...
                    'random_seed': 42,
                    'epochs': 1000}
    test_config = {'batch_size': {'ml1m': 128, 'yelp': 16, 'book': 128, 'beauty': 32, 'sports': 128, 'ml100k': 128,
                                  'tky': 128, 'nyc': 128},}
